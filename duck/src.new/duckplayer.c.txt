...
#if DEBUGFLAG
*deb++=plr->screen[0].frameNumber;
*deb++=plr->screen[1].frameNumber;
*deb++=plr->screen[2].frameNumber;
*deb++=plr->screen[3].frameNumber;
#endif
...
//DEBUGF("A very bad case in queueScreen %ld\n",framenum);
	...
	DisplayScreen(TheScreen.sc_Screens[plr->dispScreen],0); // keep it rolling
}
