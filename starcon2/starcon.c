...
PROC(STATIC
void near arilou_entrance_event, (),
    ARG_VOID
)
{
...
PROC(
void SetRaceDest, (which_race, x, y, days_left, func_index),
    ARG		(BYTE	which_race)
    ARG		(COORD	x)
    ARG		(COORD	y)
    ARG		(BYTE	days_left)
...
PROC(STATIC
void near black_urquan_genocide, (),
    ARG_VOID
)
{
    BYTE			Index;
