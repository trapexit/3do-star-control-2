...
static void	far
sis_hyper_preprocess (ElementPtr)
...
LeaveAutoPilot:
	...
	else
	{
	    ...
	    else if (facing != StarShipPtr->ShipFacing
		...
		else if (StarShipPtr->ShipFacing != facing)
		{
		    facing = NORMALIZE_FACING (facing + 1);
		    StarShipPtr->cur_status_flags |= LEFT;
		}

		if (facing == StarShipPtr->ShipFacing)
		{
...
static void	far
sis_hyper_postprocess (ElementPtr)
LPELEMENT	ElementPtr;
{
    PUSH_CONTEXT
    {
...
static void	far
sis_battle_preprocess (ElementPtr)
LPELEMENT	ElementPtr;
{
    PUSH_CONTEXT
    {
...
static void	far
sis_battle_postprocess (ElementPtr)
LPELEMENT	ElementPtr;
{
    PUSH_CONTEXT
    {
...
static void	far
blaster_collision (ElementPtr0, pPt0, ElementPtr1, pPt1)
...
static COUNT	far
initialize_blasters (ShipPtr, BlasterArray)
LPELEMENT	ShipPtr;
HELEMENT	far BlasterArray[];
{
