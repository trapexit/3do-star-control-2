...
PROC(STATIC
BYTE near BlueDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
...
PROC(STATIC
BYTE near GreenDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
    BYTE	PlanetDistribution[NUMBER_OF_PLANET_TYPES] =
...
PROC(STATIC
BYTE near OrangeDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
    BYTE	PlanetDistribution[NUMBER_OF_PLANET_TYPES] =
...
PROC(STATIC
BYTE near RedDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
    BYTE	PlanetDistribution[NUMBER_OF_PLANET_TYPES] =
...
PROC(STATIC
BYTE near WhiteDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
    BYTE	PlanetDistribution[NUMBER_OF_PLANET_TYPES] =
...
PROC(STATIC
BYTE near YellowDistribution, (which_world),
    ARG_END	(BYTE	which_world)
)
{
    BYTE	PlanetDistribution[NUMBER_OF_PLANET_TYPES] =
...
#endif /* DEBUG */
    if (GeneratingMoons = (BOOLEAN)(pBaseDesc == pSolarSysState->MoonDesc))
