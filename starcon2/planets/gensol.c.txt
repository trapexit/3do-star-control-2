...
PROC(STATIC
void near generate_energy_nodes, (),
    ARG_VOID
)
{
		/* Pluto */
...
)
{
	...
	old_rand = seed_random (pSolarSysState->SysInfo.PlanetInfo.ScanSeed[BIOLOGICAL_SCAN]);
...
)
{
    ...
    if (rand_val = DoPlanetaryAnalysis (&pSolarSysState->SysInfo,
...
)
{
	...
	case GENERATE_NAME:
	{
	    ...
	    strcpy (GLOBAL_SIS (PlanetName), planet_names[i]);
