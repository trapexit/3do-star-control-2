...
static LOCDATA	arilou_desc =
{
    ...
    ARILOU_PLAYER_PHRASES,		/* PlayerPhrases */
    20,					/* NumAnimations */
    {
	{
	    4,				/* StartIndex */
...
PROC(STATIC
void far FriendlySpaceArilou, (R),
    ARG_END	(RESPONSE_REF	R)
)
{
    PUSH_CONTEXT
...
PROC(
LOCDATAPTR far init_arilou_comm, (),
    ARG_VOID
)
{
    LOCDATAPTR	retval;
...
strcpy(aiff_folder, "comm/arilou/arilo");
