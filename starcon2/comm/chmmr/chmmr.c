...
static LOCDATA	chmmr_desc =
{
    ...
    CHMMR_PLAYER_PHRASES,		/* PlayerPhrases */
    6,					/* NumAnimations */
    {
	{
	    12,				/* StartIndex */
...
PROC_LOCAL(
void far ChmmrShielded, (R),
    ARG_END	(RESPONSE_REF	R)
);

PROC(STATIC
void far ChmmrAdvice, (R),
    ARG_END	(RESPONSE_REF	R)
)
{
    PUSH_CONTEXT
...
PROC(
LOCDATAPTR far init_chmmr_comm, (),
    ARG_VOID
)
{
    LOCDATAPTR	retval;
...
strcpy(aiff_folder, "comm/chmmr/chmmr");
