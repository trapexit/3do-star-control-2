...
static COUNT	far
initialize_megawatt_laser (ShipPtr, LaserArray)
LPELEMENT	ShipPtr;
HELEMENT	far LaserArray[];
{
    PUSH_CONTEXT
    {
#define NUM_CYCLES	4
...
LPELEMENT	ElementPtr;
{
	...
	if (StarShipPtr->cur_status_flags & WEAPON)
	{
	    ...
	    if ((LPELEMENT)MuzzleFlashPtr != ElementPtr
...
static void	far
satellite_preprocess (ElementPtr)
LPELEMENT	ElementPtr;
{
    PUSH_CONTEXT
    {
...
PROC(STATIC
void far spawn_point_defense, (ElementPtr),
...
#define DEFENSE_WAIT		2
		...
		hObject; hObject = hNextObject)
	{
		...
		if (delta_x <= DEFENSE_RANGE && delta_y <= DEFENSE_RANGE &&
			(dist =
...
static void	far
satellite_postprocess (ElementPtr)
LPELEMENT	ElementPtr;
{
    PUSH_CONTEXT
    {
...
static void	far
satellite_collision (ElementPtr0, pPt0, ElementPtr1, pPt1)
